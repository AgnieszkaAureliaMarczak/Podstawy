...
public class KolkoIKrzyzyk {
    ...
    static final char SYMBOL_CZLOWIEKA = 'X';
    static final char SYMBOL_KOMPUTERA = 'O';
    static char aktualnySymbol = SYMBOL_CZLOWIEKA;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (poprawnyRuch) {
                ...
                aktualnySymbol = aktualnySymbol == SYMBOL_CZLOWIEKA ? SYMBOL_KOMPUTERA : SYMBOL_CZLOWIEKA;
            } else {
    ...
    static boolean wykonajRuch() {
        int[] ruchGracza;
        if (aktualnySymbol == SYMBOL_CZLOWIEKA) {
